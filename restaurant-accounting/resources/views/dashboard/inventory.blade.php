...
@section('title', 'Inventory Dashboard - Restaurant Accounting')
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="payment-method-filter__actions">
                                ...
                                <a href="{{ route('inventory.dashboard') }}" class="btn payment-method-filter__btn payment-method-filter__btn--reset">
